...
<div class="page-heading">
    ...
    <section class="section">
        ...
        <form action="../routes/insertRoute.php" method="POST">
            <div class="card p-3">
                ...
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="first_name" name="first_name" placeholder="e.g. Juan" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['first_name'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="middle_name" name="middle_name" placeholder="e.g. Pedro" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['middle_name'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="last_name" name="last_name" placeholder="e.g. Dela Cruz" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['last_name'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="row gy-3">
                        <div class="col col-md-4">
                            ...
                            <input type="date" id="dob" name="dob" value="<?php echo htmlspecialchars($_POST['old_data'] ?? '') ?>" class="form-control <?php echo (!empty($errors['dob'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div style="width: 100%; height: 38px;" class="d-flex align-items-center gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="sex" id="sex" value="male" <?php echo ($_POST['old_data'] ?? '') === 'male' ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="male">Male</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="sex" id="sex" value="female" <?php echo ($_POST['old_data'] ?? '') === 'female' ? 'checked' : ''; ?>>
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <select aria-label="Default select example" name="civil_status" id="civil_status" class="form-select <?php echo (!empty($errors['civil_status'])) ? 'is-invalid' : ''; ?>">
                                ...
                                <option value="single" <?php echo ($_POST['old_data'] ?? '') === 'single' ? 'selected' : ''; ?>>Single</option>
                                <option value="married" <?php echo ($_POST['old_data'] ?? '') === 'married' ? 'selected' : ''; ?>>Married</option>
                                <option value="widowed" <?php echo ($_POST['old_data'] ?? '') === 'widowed' ? 'selected' : ''; ?>>Widowed</option>
                                <option value="separated" <?php echo ($_POST['old_data'] ?? '') === 'separated' ? 'selected' : ''; ?>>Legally Separated</option>
                                <option value="otherStatus" <?php echo ($_POST['old_data'] ?? '') === 'others' ? 'selected' : ''; ?>>Others</option>
                            </select>
                    ...
                    <div class="row gy-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="number" id="tin" name="tin" placeholder="e.g. 123-456-7890" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['tin'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="nationality" name="nationality" placeholder="e.g. Filipino" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['nationality'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="religion" name="religion" placeholder="e.g. Roman Catholic" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['religion'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="row gy-3">
                        <div class="col-12">
                            ...
                            <input type="text" id="place_of_birth" name="place_of_birth" placeholder="e.g. Manila" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['place_of_birth'])) ? 'is-invalid' : ''; ?>">
                ...
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="hidden" name="region_name" id="region_name" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="hidden" name="province_name" id="province_name" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="hidden" name="city_name" id="city_name" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>">
                    ...
                    <div class="row gy-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="hidden" name="barangay_name" id="barangay_name" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="number" id="zipcode" name="zipcode" placeholder="e.g. 1234" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['zipcode'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="home_address" name="home_address" placeholder="e.g. 123 Main Street" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['home_address'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="row gy-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="email" id="email_address" name="email_address" placeholder="e.g. example@email.com" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['email_address'])) ? 'is-invalid' : ''; ?>"> 
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="number" id="contact_number" name="contact_number" placeholder="e.g. 09123456789" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['contact_number'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="tel" id="telephone_number" name="telephone_number" placeholder="e.g. 02-81234567 or 074-4425678" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['telephone_number'])) ? 'is-invalid' : ''; ?>">
                ...
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="father_first_name" name="father_first_name" placeholder="e.g. Juan" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['father_first_name'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="father_middle_name" name="father_middle_name" placeholder="e.g. Pedro" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['father_middle_name'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="father_last_name" name="father_last_name" placeholder="e.g. Dela Cruz" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['father_last_name'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="row gy-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="mother_first_name" name="mother_first_name" placeholder="e.g. Juan" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['mother_first_name'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="mother_middle_name" name="mother_middle_name" placeholder="e.g. Pedro" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['mother_middle_name'])) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="mother_last_name" name="mother_last_name" placeholder="e.g. Dela Cruz" value="<?php echo htmlspecialchars($_POST['old_data'] ?? ''); ?>" class="form-control <?php echo (!empty($errors['mother_last_name'])) ? 'is-invalid' : ''; ?>">
